...
module.exports = {
    data: new SlashCommandBuilder().setName("clear").setDescription("clear les messages").addNumberOption(option => option.setName("nombre").setDescription("nombre de message a supprimer").setRequired(true)),
