...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('eval')
        .setDescription('une commande pour evaluer du code').addStringOption(option => option.setName("event").setDescription("l'event à lancer").setRequired(true)).addMentionableOption(option => option.setName("user").setDescription("l'utilisateur à mentionner").setRequired(true)).setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
