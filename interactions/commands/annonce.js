const {SlashCommandBuilder, TextInputStyle,PermissionFlagsBits,  PermissionsBitField, ModalBuilder, TextInputBuilder, ActionRowBuilder,
    EmbedBuilder
} = require("discord.js");
const config = require("./../../config.json");
let activeCommands = require("./../../activeCommands.json")
module.exports = {
    data: new SlashCommandBuilder().setName("annonce").setDescription("envoie une annonce").setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
    modal: true,
