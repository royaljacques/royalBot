const {ContextMenuCommandBuilder, PermissionsBitField, ApplicationCommandType, PermissionFlagsBits} = require("discord.js");
const config = require("./../../config.json");
const avisModel = require("./../../database/models/avisModel");
let activeCommands = require("./../../activeCommands.json")
module.exports = {
    data: new ContextMenuCommandBuilder().setName("getavismessage").setType(ApplicationCommandType.Message).setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
    context: true,
